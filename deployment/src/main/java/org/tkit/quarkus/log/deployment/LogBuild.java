...
import org.tkit.quarkus.log.interceptor.LoggerBuilder;
import org.tkit.quarkus.log.interceptor.LoggerBuilderService;
import org.tkit.quarkus.log.interceptor.LoggerParam;
import org.tkit.quarkus.log.interceptor.LoggerService;
...
public class LogBuild {
    ...
    static final String FEATURE_NAME = "tkit-log";
